      ...
      <div className="onboarding-layout">
        ...
        <aside style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', paddingRight: '8px' }}>
          <div>
            ...
            {/* Futuristic SkillTwin Galaxy / Planetary Orbital System */}
              ...
              <div className="galaxy-system-container">
                ...
                <div className="galaxy-core-badge">
                  <div className="galaxy-core-icon">
                    <span style={{ fontSize: '1.85rem', fontWeight: 900, color: '#FFFFFF', textShadow: '0 0 16px rgba(255,255,255,0.9)' }}>
                      S
                    </span>
                  </div>
                </div>
        ...
        {/* Right Main Form Container (Strict 2x2 Grid) */}
          ...
          {!savedProfile ? (
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', height: '100%', justifyContent: 'space-between' }}>
              ...
              <div style={{
                ...
                <span className="badge badge-info" style={{ fontSize: '0.78rem', padding: '5px 14px' }}>
                  Step 1 of 5
                </span>
